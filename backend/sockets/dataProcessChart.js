...
import sendProcessChart from '../functions/sendProcessChart.js';

dotenv.config();

async function handleDataProcessChart(ws, req) {
    ...
    const sendUpdatedData = async () => {
        let newData = await sendProcessChart(filterSearch);
...
export default handleDataProcessChart;
...
import sendProcessByName from "../functions/sendProcessbyName.js";

dotenv.config();

async function handleDataProcessByName(ws, req) {
    ...
    const sendUpdatedData = async () => {
        let newData = await sendProcessByName(filterSearch);
...
export default handleDataProcessByName;